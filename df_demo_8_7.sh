...
rosservice call /multi_mav_services/goFormLine "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [1.0, 0.0, 1.5], spacing: $SPACING}"
sleep 1
...
rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [1.0, 0.0, 1.5], spacing: 2.0}"
sleep 1
...
rosservice call /multi_mav_services/goFormLine "{roll: 0.0, pitch: -0.2, yaw: 0.0, center: [0.0, 0.0, 1.0], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to form Rectangle"
rosservice call /multi_mav_services/goFormRect "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [1.0, 0.0, 1.5], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to make angled line"
rosservice call /multi_mav_services/goFormLine "{roll: 0.0, pitch: 0.0, yaw: 0.5, center: [1.0, 0.0, 1.5], spacing: $SPACING}"
sleep 1
